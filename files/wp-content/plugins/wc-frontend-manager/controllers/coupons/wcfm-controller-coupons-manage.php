	  	...
	  	// Creating new coupon
			...
			if(!is_wp_error($new_coupon_id)) {
				...
				$wc_coupon->set_props( apply_filters( 'wcfm_coupon_data_factory', array(
					...
					'klippkort'               	  => wc_clean( $wcfm_coupon_manager_form_data['klippkort'] ), /** LANDELL 2.0 **/
				...
				update_post_meta( $new_coupon_id, 'klippkort', wc_clean( $wcfm_coupon_manager_form_data['klippkort'] ) ); /** LANDELL 2.0 **/
