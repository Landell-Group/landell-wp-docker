    ...
    function show_verification_status_message($verification_status)
    {
        ...
        switch ($verification_status) {
            ...
            case 'reject':
                ...
                $verification_status_message = __('Oops! Your verification rejected, please try again.', 'wc-frontend-manager-ultimate');
                break;
        ...
        if (isset($wcfm_verification_response_form_data['wcfm_verification_message_id']) && isset($wcfm_verification_response_form_data['wcfm_verification_vendor_id'])) {
            ...
            if ($vendor_id && $message_id) {
                ...
                if ($verification_status == 'reject') {
                    $wcfm_messages = __('<b>Oops!!!</b> Your verification rejected, please try again. <br />Added note: ', 'wc-frontend-manager-ultimate') . $verification_note;

                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Oops!!!</b> Your verification rejected, please try again. <br />Added note: %s',
    ...
    function wcfmu_vendor_manage_verification_response_update()
    {
        ...
        if (isset($wcfm_verification_response_form_data['wcfm_verification_vendor_id'])) {
            ...
            if ($vendor_id) {
                ...
                $message_to       = $vendor_id;
                if ($verification_status == 'reject') {
                    $wcfm_messages = __('<b>Oops!!!</b> Your verification has been rejected, please try again. <br />Added note: ', 'wc-frontend-manager-ultimate') . $verification_note;

                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Oops!!!</b> Your verification has been rejected, please try again. <br />Added note: %s',
                            'domain'    => 'wc-frontend-manager-ultimate',
                            'wrapper'	=> [
                                'function' 	=> 'sprintf',
                                'args' 		=> [
